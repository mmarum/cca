...
class EventsForm(Form):
    ...
    location = StringField("Location", description="Location", default="2238 Michigan Ave, Suite G, Arlington, TX 76013")
...
class RegistrationForm(Form):
    ...
    order_id = HiddenField("Order ID", description="Example: pi_3QoDBHLZJMPC73VN1")
    session_detail = HiddenField("Session detail", description="Example: art-camp-2025-2")
    camper1_name = StringField("Camper Name", description="Camper 1 Name")
    camper1_age = StringField("Camper Age", description="Camper 1 Age")
    ...
    parent_name = StringField("Parent Name", description="Parent Name")
    ...
    pickup1_name = StringField("Pickup 1 Name", description="Pickup 1 Name")
    pickup1_phone = StringField("Pickup 1 Phone", description="Pickup 1 Phone")
    pickup2_name = StringField("Pickup 2 Name 2", description="Pickup 2 Name 2")
    pickup2_phone = StringField("Pickup 2 Phone 2", description="Pickup 2 Phone 2")
